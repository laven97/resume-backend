...
router.put('/change-password', celebrate({
    body: AuthValidation.changePassword,
}), authMiddleware.checkAccessToken, commonMiddleware.isBodyValid(AuthValidation.changePassword), passwordController.changePassword);
