...
export const configs = {
  ...
  ACTION_FORGOT_PASSWORD_SECRET: process.env.ACTION_FORGOT_PASSWORD_SECRET as StringValue,
  ACTION_FORGOT_PASSWORD_EXPIRESIN:
    process.env.ACTION_FORGOT_PASSWORD_EXPIRESIN as StringValue,
  ACTION_VERIFY_EMAIL_SECRET: process.env.ACTION_VERIFY_EMAIL_SECRET as StringValue,
  ACTION_VERIFY_EMAIL_EXPIRESIN: process.env.ACTION_VERIFY_EMAIL_EXPIRESIN as StringValue,
};
